...
public abstract class SearchPrinterDialog {
    ...
    private DeviceItemView makeItem(final BluetoothDevice device) {
        ...
        int resId = R.drawable.ic_bluetooth;
